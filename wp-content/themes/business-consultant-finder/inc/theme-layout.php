     ...
     <?php
      ...
      <div class="site-info">
    	<?php
                ...
                printf( esc_html__( '%1$s By aThemeArt - Proudly powered by WordPress.', 'business-consultant-finder' ), '<a href="https://wordpress.org/themes/business-consultant-finder/" target="_blank" rel="nofollow">BCF Theme</a>' );
                ?>
      </div>
