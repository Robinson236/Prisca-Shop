...
return array(
	...
	'content'    => '
			<!-- wp:cover {"url":"' . esc_url( get_theme_file_uri( 'assets/img/ona_creative_hero.jpg' ) ) . '","id":5,"hasParallax":true,"dimRatio":40,"overlayColor":"foreground","focalPoint":{"x":"0.50","y":0},"minHeight":100,"minHeightUnit":"vh","contentPosition":"bottom center","isDark":false} -->
