...
return array(
	...
	'content'    => '
			...
			<p class="is-style-no-spacing ona-copyright ona-sm-down-text-align-center has-text-light-color has-text-color has-link-color has-tiny-font-size">' . __( '© 2022 Ona, Made by ', 'ona' ) . '<a href="https://deothemes.com">DeoThemes</a></p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:column -->
