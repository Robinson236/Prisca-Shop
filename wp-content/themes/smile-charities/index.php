...
get_header();
?>
<?php do_action( RareBiz_Helper::fn_prefix( 'before-content' ) ); ?>
					...
					<div class="row" id="load-more">
						...
						while ( have_posts() ) : the_post();
							...
							if( 'list' == $post_display ){
								...
								$class = RareBiz_Theme::is_sidebar_active() ? 'col-md-6 col-lg-6' : 'col-md-4 col-lg-4';
							}?>
...
<?php do_action( RareBiz_Helper::fn_prefix( 'after-content' ) ); ?>	
<?php get_footer() ?>