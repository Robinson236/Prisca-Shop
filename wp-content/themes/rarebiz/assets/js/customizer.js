...
wp.customize.controlConstructor['rarebiz-section-order'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';

    var control = this;
    jQuery('#customize-control-' + control.params.id).find('.rarebiz-sortable-section').sortable({
