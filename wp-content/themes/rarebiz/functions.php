...
final class RareBiz_Theme extends RareBiz_Helper{
	...
	public function __construct(){
		...
		Rarebiz_Welcome_Notice::notice_init( 'Rarebiz' );
		...
		add_action( self::fn_prefix( 'after_primary_menu' ), array( __CLASS__, 'menu_toggler' ), 99 );
	...
	*/
	public static function excerpt( $e ){
		...
		$more = sprintf( '<a href="%1$s">%2$s<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>',
	        ...
	        esc_html( rarebiz_get( 'read-more-text' ) )
	    );
	...
	*/
	...
	public static function sidebars(){
		...
		register_sidebar( array(
	        ...
	        'description' 	=> esc_html__( 'Widgets in this area will be shown on side of the page. If no widget added then default widget is displayed.', 'rarebiz' ),
	...
	*/
	public static function the_default_search(){ ?>
        <section class="widget widget_search">
			<h2 class="widget-title"><?php esc_html_e( 'Search', 'rarebiz' ); ?></h2>	        	
           <?php get_search_form(); ?>
        </section>
	<?php }
	...
	*/
	public static function the_default_recent_post(){ ?>
        <section class="widget widget_recent_entries">
			<h2 class="widget-title"><?php esc_html_e( 'Recent Posts', 'rarebiz' ); ?></h2>
			<?php $pst = Rarebiz_Theme::get_posts_by_type( 'latest', 0, 5 ); 
			if( !empty( $pst ) ):?>
				<ul>
	...
	*/
	public static function the_default_archive(){ ?>
		<section class="widget">
		    <h3 class="widget-title"><?php esc_html_e( 'Archives', 'rarebiz' ); ?></h3>
		    <ul>
